  ...
  return (
    <div className="flex-1 p-4 flex flex-col xl:flex-row gap-4">
      ...
      <div className="w-full xl:w-2/3">
        ...
        <div className="bg-lamaSky py-6 px-4 rounded-md flex-1 flex gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center justify-between gap-2 flex-wrap text-xs fomt-meduim">
        ...
        <div className="flex-1 flex gap-4 justify-between flex-wrap">
          ...
          <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
            ...
            <div className="">
              ...
              <span className="text-xs text-gray-500">Attendnce</span>
            </div>
          </div>
          {/* CARD */}
          <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
          ...
          <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
            ...
            <div className="">
              <h1 className="text-xl font-semibold">6</h1>
              <span className="text-xs text-gray-500">Classs</span>
            </div>
          </div>
        </div>
        </div>
      ...
      <div className="bg-white p-4 rounded-md">
        <h1 className="twxt-xl font-semibold">Shortcuts</h1>
